/**
 * Argument parsing for the `open-scrolltelling` CLI.
 *
...
const COMMANDS = {
  frames: {
    usage: "open-scrolltelling frames <video|image-dir> <project_dir> [options]",
    maxPositionals: 2,
    flags: {
  ...
  scaffold: {
    usage: "open-scrolltelling scaffold <project_dir> [--force] [--diff]",
    maxPositionals: 1,
    flags: {

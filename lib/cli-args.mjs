/**
 * Argument parsing for the `open-scrollytelling` CLI.
 *
...
const COMMANDS = {
  frames: {
    usage: "open-scrollytelling frames <video|image-dir> <project_dir> [options]",
    maxPositionals: 2,
    flags: {
  ...
  scaffold: {
    usage: "open-scrollytelling scaffold <project_dir> [--force] [--diff]",
    maxPositionals: 1,
    flags: {

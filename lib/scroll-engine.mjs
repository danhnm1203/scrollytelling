...
export function mount(container, options) {
  ...
  const start = () => {
    ...
    currentId = sequence.id;
    stopRun = startScrubbing({ container, sequence, framePath, onState, debug, env, log, position });
  };
 ...
 */
function startScrubbing({ container, sequence, framePath, onState, debug, env, log, position }) {
